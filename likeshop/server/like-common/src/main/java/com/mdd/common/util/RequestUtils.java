...
public class RequestUtils {
    ...
    public static String domain() {
        ...
        } else if (StringUtils.isNotNull(YmlUtils.get("like.pc.url"))) {
            return YmlUtils.get("like.pc.url");
        } else if (StringUtils.isNotNull(YmlUtils.get("like.mobile.url"))) {
            return YmlUtils.get("like.mobile.url");
        } else {
            HttpServletRequest request = RequestUtils.handler();
            if (request != null) {
