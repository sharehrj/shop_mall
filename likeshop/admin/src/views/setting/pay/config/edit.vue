        ...
        >
            <el-form ref="formRef" :model="formData" label-width="84px" :rules="formRules">
                ...
                <template v-if="formData.way == PayWayEnum.WECHAT">
                    ...
                    <el-form-item label="商户号" prop="params.mch_id">
                        <div class="flex-1">
                            <el-input
                    ...
                    <el-form-item label="商户APIv3密钥" prop="params.pay_sign_key">
                        <el-input
                            v-model="formData.params.pay_sign_key"
                            placeholder="请输入微信支付商户API密钥"
                        />
                        <span class="form-tips">微信支付商户APIv3密钥（paySignKey）</span>
                    </el-form-item>
                    ...
                    <el-form-item label="微信支付密钥" prop="params.private_key">
                        <el-input
                            type="textarea"
                            rows="3"
                    ...
                    <el-form-item label="微信支付公钥" prop="params.wechat_public_cert">
                        <el-input
                            type="textarea"
                            rows="3"
                            v-model="formData.params.wechat_public_cert"
                            placeholder="请输入微信支付公钥"
                        />

                        <span class="form-tips">
                            微信支付公钥，前往微信商家平台下载并黏贴至此处
                        </span>
                    </el-form-item>

                    <el-form-item label="微信公钥ID" prop="params.wechat_public_serial">
                        <el-input
                            v-model="formData.params.wechat_public_serial"
                            placeholder="请输入微信支付公钥ID"
                        />
                        <span class="form-tips"
                            >微信支付公钥ID，前往微信商家平台生成并黏贴至此处</span
                        >
                    </el-form-item>
