    ...
    <div>
        <el-form label-width="70px">
            ...
            <el-form-item label="副标题">
                <el-input class="w-[230px]" v-model="content.sub_title" show-word-limit maxlength="15"></el-input>
            </el-form-item>
            <el-form-item label="显示数量">
                <div class="w-[400px]">
                    <div class="flex">
                        <el-slider class="w-[250px]" v-model="content.num" :max="20" :min="1" show-input />
                    </div>
